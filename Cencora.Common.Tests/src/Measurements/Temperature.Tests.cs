...
public class TemperatureUnitExtensionsTests
{
    ...
    {
        const TemperatureUnit unit = (TemperatureUnit) 42;
...
public class TemperatureTests(ITestOutputHelper output)
{
    ...
    public void Json_Serialize_ShouldReturnCorrectJson()
    {
        ...
        var json = JsonSerializer.Serialize(temperature, _options);
    ...
    {
        const string json = "{\"value\":273.15,\"unit\":\"k\"}";
        var temperature = JsonSerializer.Deserialize<Temperature>(json, _options);
...
public class TemperatureConverterTests
{
    ...
    {
        const string json = "{\"value\":10,\"unit\":\"°C\"}";
        var temperature = JsonSerializer.Deserialize<Temperature>(json, _options);
