...
public class ApiResponseTests
{
    ...
    public void Success_WithParameters_ShouldCreateInstance()
    {
        ...
        response = ApiResponse.Success(HttpStatusCode.OK);
        Assert.Equal(200, response.StatusCode);
    }
    ...
    {
        const string expected = "{\"statusCode\":201}";
    ...
    {
        const string json = "{\"statusCode\":200}";
...
public class GenericApiResponseTests
{
    ...
    private static void Success(bool val, int code)
    {
        Assert.True(val);
    ...
    public void Json_Serialize_ShouldReturnCorrectJson()
    {
        const string expected = "{\"statusCode\":201,\"payload\":true}";
...
public class GenericApiResponseConverterTests
{
    ...
    public void Read_WithApiResponse_ShouldReturnCorrectInstance()
    {
        const string json = "{\"statusCode\":200,\"payload\":true}";
        var response = JsonSerializer.Deserialize<ApiResponse<bool>>(json, _options);
