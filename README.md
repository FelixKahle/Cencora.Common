...
`Cencora.Common` contains shared code and utilities that are used across various Cencora services. This project aims to provide reusable components, helpers, and utilities to promote code consistency and reduce duplication across different services.
