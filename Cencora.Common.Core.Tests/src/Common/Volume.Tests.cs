...
namespace Cencora.Common.Core.Tests
{
    ...
    public class VolumeTests
    {
        ...
        public void Json_Serialize_ShouldReturnCorrectJson()
        {
            ...
            var volume = new Volume(1, VolumeUnit.CubicMeter);
            string json = JsonSerializer.Serialize<Volume>(volume, options);
        ...
        public void Json_Deserialize_ShouldReturnCorrectInstance()
        {
            ...
            string json = "{\"value\":1,\"unit\":\"m3\"}";
            var volume = JsonSerializer.Deserialize<Volume>(json, options);
