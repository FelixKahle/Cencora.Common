...
namespace Cencora.Common.Core.Tests
{
    public class DateTimeRangeTests
    {
        ...
        public void Equals_WithEqualInstances_ShouldReturnTrue()
        {
            ...
            var dateTimeRange1 = new DateTimeRange(start, end);
            var dateTimeRange2 = new DateTimeRange(start, end);
        ...
        public void Equals_WithDifferentInstances_ShouldReturnFalse()
        {
            ...
            var dateTimeRange1 = new DateTimeRange(start, end);
            var dateTimeRange2 = new DateTimeRange(start, end.AddDays(1));
        ...
        public void Overlaps_WithOverlappingRangesAndFittingTimespan_ShouldReturnTrue()
        {
            ...
            var dateTimeRange1 = new DateTimeRange(start1, end1);

            var start2 = new DateTime(2024, 1, 2);
            var end2 = new DateTime(2024, 1, 4);
            var dateTimeRange2 = new DateTimeRange(start2, end2);

            Assert.True(DateTimeRange.Overlaps(dateTimeRange1, dateTimeRange2, TimeSpan.FromDays(1)));
        ...
        public void Overlaps_WithOverlappingRangesAndNonFittingTimespan_ShouldReturnFalse()
        {
            ...
            Assert.False(DateTimeRange.Overlaps(dateTimeRange1, dateTimeRange2, TimeSpan.FromDays(2)));
        ...
        public void Overlaps_WithoutOverlappingRangesAndNonFittingTimespan_ShouldReturnFalse()
        {
            ...
            Assert.False(DateTimeRange.Overlaps(dateTimeRange1, dateTimeRange2, TimeSpan.FromDays(1)));
            Assert.False(dateTimeRange1.Overlaps(dateTimeRange2, TimeSpan.FromDays(2)));
        }
        ...
        public void Overlaps_WithoutOverlappingRanges_ShouldReturnFalse()
        {
            ...
            Assert.False(DateTimeRange.Overlaps(dateTimeRange1, dateTimeRange2));
        ...
        public void Overlaps_WithOverlappingRanges_ShouldReturnTrue()
        {
            ...
            Assert.True(DateTimeRange.Overlaps(dateTimeRange1, dateTimeRange2));
        ...
        public void Contains_WithTimePointInRange_ShouldReturnTrue()
        {
            ...
            Assert.True(DateTimeRange.Contains(dateTimeRange, point));
        ...
        public void Contains_WithTimePointNotInRange_ShouldReturnFalse()
        {
            ...
            Assert.False(DateTimeRange.Contains(dateTimeRange, point));
        ...
        public void Contains_WithTimeRangeInRange_ShouldReturnTrue()
        {
            ...
            Assert.True(DateTimeRange.Contains(dateTimeRange, dateTimeRange2));
        ...
        public void Contains_WithTimeRangeNotInRange_ShouldReturnFalse()
        {
            ...
            Assert.False(DateTimeRange.Contains(dateTimeRange, dateTimeRange2));
        ...
        public void Intersection_WithOverlappingRangesAndFittingTimespan_ShouldReturnIntersection()
        {
            ...
            // Static method
            var intersection = DateTimeRange.Intersection(dateTimeRange1, dateTimeRange2, TimeSpan.FromDays(1));
        ...
        public void Intersection_WithOverlappingRangesAndNonFittingTimespan_ShouldReturnNull()
        {
            ...
            // Static method
            var intersection = DateTimeRange.Intersection(dateTimeRange1, dateTimeRange2, TimeSpan.FromDays(2));
        ...
        public void Intersection_WithOverlappingRanges_ShouldReturnIntersection()
        {
            ...
            // Static method
            var intersection = DateTimeRange.Intersection(dateTimeRange1, dateTimeRange2);
            Assert.NotNull(intersection);
            Assert.Equal(expectedStart, intersection?.Start);
            Assert.Equal(expectedEnd, intersection?.End);
