...
public struct GeoCoordinate : IEquatable<GeoCoordinate>
{
    ...
    public static readonly GeoCoordinate Zero = new(0, 0);
    public static readonly GeoCoordinate Unknown = new(double.NaN, double.NaN);
    ...
    public Distance GetDistanceTo(GeoCoordinate other)
    {
        ...
        var lon2 = other.Longitude * (Math.PI / 180.0);
